...
public class PictureAiProfileServiceImpl implements PictureAiProfileService {
    ...
    // @Lazy avoids circular dependency when GalleryServiceImpl also injects PictureAiProfileService
    ...
    public PictureAiProfile analyze(Long pictureId) {
        ...
        String key = "gallery/" + picture.userId() + "/" + pictureId + "/origin." + ext;
        byte[] imageBytes = storageService.download(key);
