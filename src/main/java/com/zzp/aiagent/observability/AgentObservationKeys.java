...
public final class AgentObservationKeys {
    ...
    public static final class Low {
        ...
        public static final String TASK_OUTCOME = "agent.task.outcome";
        public static final String REQUEST_MODE = "agent.request.mode";
        public static final String REQUEST_CONTENT_CAPTURED = "agent.request.content_captured";
        public static final String EXECUTOR_TYPE = "agent.executor.type";
        public static final String PLAN_SOURCE = "agent.plan.source";
        public static final String PLAN_VALIDATION = "agent.plan.validation";
        public static final String PLAN_REPAIR_ATTEMPTED = "agent.plan.repair_attempted";
        public static final String PLAN_FALLBACK_USED = "agent.plan.fallback_used";
        public static final String OUTCOME = "agent.outcome";
        public static final String TOOL_NAME = "agent.tool.name";
        public static final String TOOL_OUTCOME = "agent.tool.outcome";
        ...
        public static final String VERIFY_VERDICT = "agent.verify.verdict";
        public static final String VERIFY_NO_SAVE = "agent.verify.constraint.no_save";
        public static final String VERIFY_RESULT_COUNT = "agent.verify.constraint.result_count";
        public static final String MEMORY_WRITE = "agent.memory.write";
        public static final String MEMORY_WRITE_REASON = "agent.memory.write_reason";
        ...
        public static final String MCP_TRACE_CONTEXT_PROPAGATED = "agent.mcp.trace_context_propagated";
    ...
    public static final class High {
        ...
        public static final String DEMO_CASE_ID = "agent.demo.case_id";
        public static final String TURN_ID = "agent.turn.id";
        public static final String REQUEST_CONTENT_LENGTH = "agent.request.content_length";
        public static final String REQUEST_CONTENT_HASH = "agent.request.content_hash";
        public static final String PLAN_STEP_COUNT = "agent.plan.step_count";
        ...
        public static final String GENERATION_REFERENCE_COUNT = "agent.generation.reference.count";
        public static final String TOOL_RESULT_COUNT = "agent.tool.result_count";
        public static final String MCP_RESULT_COUNT = "agent.mcp.result.count";
        public static final String VERIFY_REQUIRED_STEP_COUNT = "agent.verify.required_step_count";
        public static final String VERIFY_COMPLETED_REQUIRED_STEP_COUNT =
                "agent.verify.completed_required_step_count";
        public static final String VERIFY_EVIDENCE_COUNT = "agent.verify.evidence_count";
        public static final String MEMORY_MESSAGE_COUNT = "agent.memory.message_count";
        public static final String TOOL_ATTEMPT = "agent.tool.attempt";
        public static final String MODEL_TIME_TO_FIRST_CHUNK_MS =
                "gen_ai.response.time_to_first_chunk_ms";
        public static final String HTTP_TIME_TO_FIRST_SSE_TOKEN_MS =
                "agent.http.time_to_first_sse_token_ms";
